...
class _CallPageState extends State<CallPage> {
  ...
  void initialize() {
    ...
    AgoraRtcEngine.joinChannel('006a29b5593ff514315ade94587d86ea5dfIACqQ46JfbkpYG8P1jHruGXCW/8UB5BdOKoPbpsrxYYIYQx+f9gAAAAAEAD27b1wRi6uXQEAAQBGLq5d', widget.channelName, null, 0);
  }
...
//  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Channel: $_infoStrings'),
          elevation: 0,
